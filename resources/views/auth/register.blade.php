<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Surname -->
        <div class="mt-4">
            <x-input-label for="sur_name" :value="__('Sur_name')" />
            <x-text-input id="sur_name" class="block w-full mt-1" type="text" name="sur_name" :value="old('sur_name')" required autocomplete="sur_name" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="group" class="block w-full mt-1" type="text" name="group" :value="old('group')" required autocomplete="group" />
